...
async function getTransactionById(req, res) {
    ...
    // Verify user owns either fromAccount or toAccount
    ...
    const hasAccess = userAccountIds.includes(transaction.fromAccount.toString()) ||
    ...
    const ledgerEntries = await ledgerModel.find({ transaction: transactionId })
